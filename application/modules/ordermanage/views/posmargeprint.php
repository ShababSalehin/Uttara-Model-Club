        ...
        <div class="invoice-card">
            ...
            <div class="invoice-footer mb-15">
                ...
                <?php }else{
                    ...
                    <h5 class="my-5"><?php if($currency->position==1){echo $currency->curr_icon;}?> <?php echo number_format($multiplletax['tax'.$i]);?>  <?php if($currency->position==2){echo $currency->curr_icon;}?></h5>
                </div>
