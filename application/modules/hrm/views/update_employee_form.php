                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="city">User Login Email</label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="benifit_acc_date" name="reports"
                                                placeholder="<?php echo display('reports') ?>" value="<?php echo $data->supervisor_report; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="h_email" name="h_email"
                                                placeholder="<?php echo display('home_email') ?>" value="<?php echo $data->home_email; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="h_phone" name="h_phone"
                                                placeholder="<?php echo display('home_phone') ?>" value="<?php echo $data->home_phone; ?>">
